...
model <- function(t, y, parms){
  with(as.list(c(y, parms)), {
    ...
    # Accelerations
    az <- (-k * velocity.z * V + lambda * (angular.y*velocity.x- angular.x * velocity.y) 
           * e^-mu - m * g) / m
    ax <- (-k * velocity.x * V + lambda * (angular.y*velocity.z- angular.z * velocity.y) 
           * e^-mu) / m
    ay <- (-k * velocity.y * V  + lambda * (angular.x*velocity.z- angular.z * velocity.x) 
           * e^-mu) / m
...
travelling to the left. This is the Magnus effect.
```{r fig.cap="A 3d plot showing the same trajectory", fig.show='hold', fig.align='center', out.width='50%'}
