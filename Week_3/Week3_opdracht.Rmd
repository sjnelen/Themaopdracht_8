...
ggplot(data = output.normal, aes(x=time)) + 
  ...
  geom_line(data = output.adjusted, aes(x=time, y=dr, color = "Adjusted")) +
  scale_color_brewer("",
...
D.steady.second <- as.data.frame(ode(y = state, 
                                          times = times, 
                                          func = model, 
                                          parms = parameters))

ggplot(data = D.steady, aes(x=time)) + 
  geom_line(aes(y=mRNA.R)) +
  geom_line(data = D.steady.second, aes(x=time, y=mRNA.R))
...
plot_grid(kre.mRNA.R, kre.R, labels = "AUTO")
```
...
plot.ks_Rm.mRNA_R <- ggplot(output.normal, aes(x = time)) + geom_line(aes(y = mRNA.R, color = "Normal")) +
...
plot.ks_Rm.R <- ggplot(output.normal, aes(x = time)) + geom_line(aes(y = R, color = "Normal")) +
...
plot.ks_Rm.dr <- ggplot(output.normal, aes(x = time)) + geom_line(aes(y = dr, color = "Normal")) +
...
plot.ks_Rm.drn <- ggplot(output.normal, aes(x = time)) + geom_line(aes(y = drn, color = "Normal")) +
