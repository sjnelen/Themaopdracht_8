...
```{r steadyState}
#| fig_cap = "De werking van het medicijn op de mRNA en receptor concentratie"
...
gekeken naar de mRNA en receptor concentraties in figuur \@reg(fig:steadyState).
...
```{r differentCort}
#| fig_cap = "De werking van verschillende corticosteroïden"
parameters <- c(ks_Rm = 2.90, IC50_Rm = 26.2, kon = 0.00329, kT = 0.63, kre = 0.57, 
                Rf = 0.49, kd_R = 0.0572, kd_Rm = 0.612, ksr = 3.22, 
                D = 20 * 1000 * (1/ molar.mass))
...
```{r blockedSynthese}
#| fig_cap = "Hier is het verloop van het model te zien als er geen synthese
